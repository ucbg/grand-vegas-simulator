...
function UnityProgress(gameInstance, progress) {
    ...
    {
        gameInstance.textProgress.innerHTML = 'Opening..' +' <img src="' + rootPath + '/gears.gif" class="spinner" />';
        gameInstance.progress.style.display = 'none';
    }
    else
    {
        gameInstance.textProgress.innerHTML = 'Grand Vegas Simulator ' + Math.floor(progress * 100) + '%' + ' <img src="' + rootPath + '/gears.gif" class="spinner" />';
    }
